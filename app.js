...
function _profAvatarHairBack(style, H, HD, out) {
    if (style === 'bob') {
        ...
        // Wide triangular back mass — narrow at crown, widens to near-full avatar width
...
function _profAvatarHairFront(style, H, HD, out) {
    ...
    const shapes = {
        ...
        long_curly:     `<path d="M26 38 Q26 18 50 15 Q74 18 74 38 Q68 34 50 32 Q32 34 26 38Z" fill="${H}"/>
                         <path d="M26 38 Q20 46 18 56 Q16 66 18 72 Q20 76 22 72 Q24 64 24 54 Q25 46 26 38Z" fill="${H}"/>
                         <path d="M74 38 Q80 46 82 56 Q84 66 82 72 Q80 76 78 72 Q76 64 76 54 Q75 46 74 38Z" fill="${H}"/>`,
